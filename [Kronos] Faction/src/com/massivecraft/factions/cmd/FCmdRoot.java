...
public class FCmdRoot extends FCommand
{
	...
	public CmdClassement cmdClassement = new CmdClassement();
	public CmdAddPoint cmdAddPoint = new CmdAddPoint();
	...
	public FCmdRoot()
	{
		...
		this.addSubCommand(this.cmdClassement);
		this.addSubCommand(this.cmdAddPoint);
	}
