...
public class CmdDisband extends FCommand
{
	...
	public void perform()
	{
		...
		for (FPlayer fplayer : FPlayers.i.getOnline())
		{
			...
			{
				fplayer.msg(P.prefix +"La Factions vient d'être suppimer.", who);
			}
			else
			{
				fplayer.msg(P.prefix +"§eLe joueur %s §evient de supprimé la Factions §a%s§e.", who, faction.getTag(fplayer));
			}
		}
