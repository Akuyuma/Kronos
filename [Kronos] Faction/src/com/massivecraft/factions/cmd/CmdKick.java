...
public class CmdKick extends FCommand
{
	...
	{	
		...
		if (fme == you)
		{
			msg(P.prefix +"§eVous ne pouvez pas vous éjecter de votre Faction vous-même.");
			return;
		}
		...
		if ( ! Permission.KICK_ANY.has(sender))
		{
			...
			if (you.getRole().value >= fme.getRole().value)
			{
				...
				msg(P.prefix +"§eVous ne pouvez pas éjecter un membre de votre Factions.");
				return;
			}
		...
		yourFaction.msg(P.prefix +"§e%s<i> vient d'éjecter %s de votre Faction.", fme.describeTo(yourFaction, true), you.describeTo(yourFaction, true));
		if (yourFaction != myFaction)
		{
