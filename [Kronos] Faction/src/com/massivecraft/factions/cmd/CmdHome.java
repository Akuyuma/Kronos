...
public class CmdHome extends FCommand
{
	...
	public void perform()
	{
		...
		{
			fme.msg(P.prefix +"§eVous ne pouvez pas vous téléporter à votre home de Factions car vous êtes dans un territoire ennemie.");
			return;
		}
		...
		)
		{
			...
			for (Player p : me.getServer().getOnlinePlayers())
			{
				...
				fme.msg(P.prefix +"§eVous ne pouvez pas vous téléporter dans votre home de Factions car vous avez des enemies autours de " + Conf.homesTeleportAllowedEnemyDistance + " blocs.");
				return;
			}
		}
