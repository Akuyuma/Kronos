...
public class CmdChat extends FCommand
{
	...
	public void perform()
	{
		...
		{
			msg(P.prefix +"Vous êtes désormais dans la canal §aPublic§e.");
		}
		else if (fme.getChatMode() == ChatMode.ALLIANCE )
		{
			msg(P.prefix +"Vous êtes désormais dans la canal §aAlliance§e.");
		}
		else
		{
			msg(P.prefix +"Vous êtes désormais dans la canal §aFactions§e.");
		}
	}
}
