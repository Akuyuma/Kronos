...
public class P extends MPlugin
{
	...
	public static FileConfiguration rankup;	
	public static File Filerankup;	
	...
	public static String prefix = "§6» §e";
	...
	public void saveStorage(){
		try {rankup.save(Filerankup);} catch (IOException e) {e.printStackTrace();}
	}
