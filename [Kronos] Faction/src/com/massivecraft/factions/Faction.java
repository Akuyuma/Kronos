...
public class Faction extends Entity implements EconomyParticipator
{
	...
	public void confirmValidHome()
	{
		...
		msg("§6» <b>Votre home de faction a été supprimé puisqu'il n'est plus sur votre territoire.");
		this.home = null;
	}
	...
	public Faction()
	{
		...
		this.tag = "???";
		this.description = "Sans aucune description";
		this.lastPlayerLoggedOffTime = 0;
		this.classementpoint = 0;
	...
	public void setClassementPosition(int classement){
		this.classement = classement;
	}
	
	public int getClassementPoint(){
		return this.classementpoint;
	}
	
	public void setClassementPoint(int point){
		this.classementpoint = point;
	}
	
	public void addClassementPoint(int point){
		this.classementpoint += point;
	}
	...
	public int getEnemySize(Faction faction){
		int enemy = 0;
	...
	public int getAllysize(Faction faction){
		int ally = 0;
		for (Faction otherFaction : Factions.i.get())
		{
			if (otherFaction == faction) continue;
	...
	public void promoteNewLeader()
	{
		...
		{	// faction admin is the only member; one-man faction
			...
			{
				fplayer.msg("§6» §eLa faction %s§e vient d'être dissoute.", this.getTag(fplayer));
			}
		...
		{	// promote new faction admin
			...
			this.msg("§6» <i>L'admin de la faction <h>%s<i> vient d'être retiré. %s<i> a été promu en tant que nouvel administrateur de faction.", oldLeader == null ? "" : oldLeader.getName(), replacements.get(0).getName());
