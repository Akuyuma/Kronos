...
public class TotemManager {
	...
	private fr.maxlego08.core.command.commands.stotem.data.TotemData totem = new fr.maxlego08.core.command.commands.stotem.data.TotemData();
	...
	public fr.maxlego08.core.command.commands.stotem.data.TotemData getTotem() {
		return totem;
	}
