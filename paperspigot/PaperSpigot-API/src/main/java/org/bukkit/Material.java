...
import org.bukkit.material.ChilliPepperPlant;
...
public enum Material {
    ...
    ANGELITE_PICKAXE(428, 1, 6000),
    ANGELITE_AXE(429, 1, 6000),
    ANGELITE_HOE(430, 1, 6000),
    ANGELITE_SHOVEL(431, 1, 6000),
    ANGELITE_MULTITOOLS(432, 1, 6000),
    
	CELESTINE_PICKAXE(433, 1, 5000),
	CELESTINE_AXE(434, 1, 5000),
	CELESTINE_HOE(435, 1, 5000),
	CELESTINE_SHOVEL(436, 1, 5000),
	CELESTINE_MULTITOOLS(437, 1, 5000),
	
	MALACHITE_PICKAXE(438, 1, 4500),
	MALACHITE_AXE(439, 1, 4500),
	MALACHITE_HOE(440, 1, 4500),
	MALACHITE_SHOVEL(441, 1, 4500),
	MALACHITE_MULTITOOLS(442, 1, 4500),
	
	CELENITE_PICKAXE(443, 1, 4000),
	CELENITE_AXE(444, 1, 4000),
	CELENITE_HOE(445, 1, 4000),
	CELENITE_SHOVEL(446, 1, 4000),
	CELENITE_MULTITOOLS(447, 1, 4000),
	
	ANGELITE_SWORD(448, 1, 6000),
	CELESTINE_SWORD(449, 1, 5000),
	MALACHITE_SWORD(450, 1, 4500),
	CELENITE_SWORD(451, 1, 4000),
	
	ANGELITE_HELMET(452),
	ANGELITE_CHESTPLATE(453),
	ANGELITE_LEGGINGS(454),
	ANGELITE_BOOTS(455),
	
	CELESTINE_HELMET(456),
	CELESTINE_CHESTPLATE(457),
	CELESTINE_LEGGINGS(458),
	CELESTINE_BOOTS(459),
	
	MALACHITE_HELMET(460),
	MALACHITE_CHESTPLATE(461),
	MALACHITE_LEGGINGS(462),
	MALACHITE_BOOTS(463),
	
	CELENITE_HELMET(464),
	CELENITE_CHESTPLATE(465),
	CELENITE_LEGGINGS(466),
	CELENITE_BOOTS(467),	
    
	MALEFICIENT_SCYTHE(468),
	
	BLADES_OF_ARES(469),
	
	POSITIVE_GRAPES(470),
	GOLDEN_GRAPES(471),
	HEPHAISTOS_GRAPES(472),
	...
	STICK_OF_TARTARE(481, 1),
	
	WATER_CAPSULE(482, 1),
	WATER_CAPSULE_EMPTY(483, 16),
	
	GALAAD_SWORD(484, 1),
	
	SOUL_OF_ANGELIC_SPAWNER(485, 1),
	
	SOUL_OF_DEMONIC_SPAWNER(486, 1),
	
	POWER_OF_HADES(487, 1),
	
	HAMMER_OF_HESTIA(488, 1),
	
	CHILLI_PEPPER_ITEM(489, 1),
	
	POWER_OF_HERMES(490, 1),
    ...
    CELENITE_BOW(495, 1, 536),
    MALACHITE_BOW(496, 1, 750),
    CELESTINE_BOW(497, 1, 863),
    ANGELITE_BOW(498, 1, 1134),
    
    ANGELITE_ARROW(499),
    
    APOLON_BOW(500, 1, 1036),
    
    KUNEES_OF_HADES(501, 3),
    
    GOD_PEARL(502, 16),
    
    BAGUETTE_XRAY(503, 1, 20),
    ...
    CHILLI_PEPPER(194, ChilliPepperPlant.class),
    ...
    public boolean isEdible() {
        switch (this) {
            ...
            case ROTTEN_FLESH:
            case SPIDER_EYE:
            case POSITIVE_GRAPES:
            case GOLDEN_GRAPES:
            case HEPHAISTOS_GRAPES:
            case FIRE_GRAPES:
            case SPEED_GRAPES:
            case STRENGHT_GRAPES:
                return true;
            default:
                return false;
        }
    ...
    public boolean isSolid() {
        ...
        switch (this) {
            ...
            case ANGELITE_BLOCK:          	
            case CELESTINE_ORE:
            case CELESTINE_BLOCK:          	
            case MALACHITE_ORE:
            case MALACHITE_BLOCK:          	
            case CELENITE_ORE:
            case CELENITE_BLOCK:   
            case RANDOM_ORE:	
            case XP_ORE:	
            case ANGELITE_CHEST:
            case CELESTINE_CHEST:
            case MALACHITE_CHEST:
            case CELENITE_CHEST:
            case CHILLI_PEPPER:
