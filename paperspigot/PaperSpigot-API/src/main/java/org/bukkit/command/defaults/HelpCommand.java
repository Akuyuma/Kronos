...
public class HelpCommand extends VanillaCommand {
    ...
    public boolean execute(CommandSender sender, String currentAlias, String[] args) {
        ...
        player.sendMessage(ChatColor.RED + "§lWelcome on NK");
        player.sendMessage("");
        player.sendMessage(ChatColor.RED + "Site" + ChatColor.WHITE + ": (soon)");
        player.sendMessage(ChatColor.RED + "TeamSpeak" + ChatColor.WHITE + ": (soon)");
        player.sendMessage(ChatColor.RED + "Twitter" + ChatColor.WHITE + ": @NKPractice");
        player.sendMessage(ChatColor.RED + "Discord" + ChatColor.WHITE + ": (soon)");
        player.sendMessage(ChatColor.RED + "§7§m---------------------------------------------------");
    ...
    public List<String> tabComplete(CommandSender sender, String alias, String[] args) {
        ...
        if (!testPermission(sender)) return null;
