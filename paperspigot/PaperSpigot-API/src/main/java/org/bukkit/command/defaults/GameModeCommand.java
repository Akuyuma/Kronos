        ...
        if (player != null) {
            ...
            if (mode != player.getGameMode()) {
                ...
                if (mode != player.getGameMode()) {
                    ...
                    if (player == sender) {
                        Command.broadcastCommandMessage(sender, ChatColor.GRAY + "Set own game mode to "+ ChatColor.RED  + mode.toString() + ChatColor.GRAY+" mode");
                    } else {
                        Command.broadcastCommandMessage(sender, ChatColor.GRAY+ "Set "+ ChatColor.RED + player.getName() + ChatColor.GRAY +"'s game mode to "+ ChatColor.RED + mode.toString() + ChatColor.GRAY +" mode");
                    }
                }
            } else {
