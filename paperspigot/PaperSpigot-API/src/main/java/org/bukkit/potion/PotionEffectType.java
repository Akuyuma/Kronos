...
public abstract class PotionEffectType {
    ...
    public static final PotionEffectType ANTIBACKAP = new PotionEffectTypeWrapper(24);
   
    public static final PotionEffectType NOFALL = new PotionEffectTypeWrapper(25);
