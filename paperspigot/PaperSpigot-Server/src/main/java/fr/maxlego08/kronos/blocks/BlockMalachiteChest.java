...
public class BlockMalachiteChest extends BlockContainer
{
	  ...
	  protected BlockMalachiteChest(int i)
	  {
	  ...
	  public void doPhysics(World world, int i, int j, int k, Block block)
	  {
	    ...
	    TileEntityMalachiteChest TileEntityAsphateChest = (TileEntityMalachiteChest)world.getTileEntity(i, j, k);
	  ...
	  {
	    Object object = (TileEntityMalachiteChest)world.getTileEntity(i, j, k);
	    return (IInventory)object;
	  }
	  
	  public TileEntity a(World world, int i)
	  {
	    TileEntityMalachiteChest TileEntityAsphateChest = new TileEntityMalachiteChest();
	  ...
	  public int b(IBlockAccess iblockaccess, int i, int j, int k, int l)
	  {
	    ...
	    int i1 = ((TileEntityMalachiteChest)iblockaccess.getTileEntity(i, j, k)).o;
