...
public class TileEntityCeleniteChest extends TileEntity
implements IInventory
{
	private ItemStack[] items = new ItemStack[54];
	public boolean a;
	public TileEntityCeleniteChest i;
	public TileEntityCeleniteChest j;
	public TileEntityCeleniteChest k;
	public TileEntityCeleniteChest l;
	public float m;
	public float n;
	public int o;
	private int ticks;
...
{
  return k_() ? this.s : "container.celetinechest";
}
