...
public class BlockCelestineChest extends BlockContainer
{
	  ...
	  protected BlockCelestineChest(int i)
	  {
	  ...
	  public void doPhysics(World world, int i, int j, int k, Block block)
	  {
	    ...
	    TileEntityCelestineChest TileEntityAsphateChest = (TileEntityCelestineChest)world.getTileEntity(i, j, k);
	  ...
	  {
	    Object object = (TileEntityCelestineChest)world.getTileEntity(i, j, k);
	    return (IInventory)object;
	  }
	  
	  public TileEntity a(World world, int i)
	  {
	    TileEntityCelestineChest TileEntityAsphateChest = new TileEntityCelestineChest();
	  ...
	  public int b(IBlockAccess iblockaccess, int i, int j, int k, int l)
	  {
	    ...
	    int i1 = ((TileEntityCelestineChest)iblockaccess.getTileEntity(i, j, k)).o;
