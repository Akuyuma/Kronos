...
public class ItemAngeliteBow extends ItemBow{
	...
	public ItemAngeliteBow() {
		setMaxDurability(1134);
	}
	
    public void a(ItemStack itemstack, World world, EntityHuman entityhuman, int i) {
        boolean flag = entityhuman.abilities.canInstantlyBuild ;

        if (flag || entityhuman.inventory.b(Items.ANGELITE_ARROW)) {
...
//            }
            ...
            if (flag) {
                ...
                entityhuman.inventory.a(Items.ANGELITE_ARROW);
            }
    ...
    public ItemStack a(ItemStack itemstack, World world, EntityHuman entityhuman) {
        if (entityhuman.abilities.canInstantlyBuild || entityhuman.inventory.b(Items.ANGELITE_ARROW)) {
