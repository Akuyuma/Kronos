...
public class TileEntityCelestineChest extends TileEntity
implements IInventory
{
	private ItemStack[] items = new ItemStack[54];
	public boolean a;
	public TileEntityCelestineChest i;
	public TileEntityCelestineChest j;
	public TileEntityCelestineChest k;
	public TileEntityCelestineChest l;
	public float m;
	public float n;
	public int o;
	private int ticks;
...
{
  return k_() ? this.s : "container.celestinechest";
}
