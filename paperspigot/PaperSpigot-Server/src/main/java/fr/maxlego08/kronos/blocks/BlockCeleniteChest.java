...
public class BlockCeleniteChest extends BlockContainer
{
	  ...
	  protected BlockCeleniteChest(int i)
	  {
	  ...
	  public void doPhysics(World world, int i, int j, int k, Block block)
	  {
	    ...
	    TileEntityCeleniteChest TileEntityAsphateChest = (TileEntityCeleniteChest)world.getTileEntity(i, j, k);
	  ...
	  {
	    Object object = (TileEntityCeleniteChest)world.getTileEntity(i, j, k);
	    return (IInventory)object;
	  }
	  
	  public TileEntity a(World world, int i)
	  {
	    TileEntityCeleniteChest TileEntityAsphateChest = new TileEntityCeleniteChest();
	  ...
	  public int b(IBlockAccess iblockaccess, int i, int j, int k, int l)
	  {
	    ...
	    int i1 = ((TileEntityCeleniteChest)iblockaccess.getTileEntity(i, j, k)).o;
