...
public class TileEntityAngeliteChest   extends TileEntity
implements IInventory
{
	private ItemStack[] items = new ItemStack[54];
	public boolean a;
	public TileEntityAngeliteChest i;
	public TileEntityAngeliteChest j;
	public TileEntityAngeliteChest k;
	public TileEntityAngeliteChest l;
	public float m;
	public float n;
	public int o;
	private int ticks;
...
{
  return k_() ? this.s : "container.angelitechest";
}
