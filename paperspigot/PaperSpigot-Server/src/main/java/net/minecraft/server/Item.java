...
public class Item {
    ...
    public static void l() {
        ...
        for(fr.maxlego08.kronos.items.Items items : Items.values()){
        	REGISTRY.a(itemId, items.getName(), items.getItem().a(items.getTabs()).f(items.getName()).c(items.getName()));
        	itemId++;
        }
    ...
    public Item setMaxDurability(int i) {
        this.durability = i;
        return this;
    }
