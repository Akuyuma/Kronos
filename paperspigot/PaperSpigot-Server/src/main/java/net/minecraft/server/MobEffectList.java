...
public class MobEffectList {
    ...
    public static final MobEffectList ANTIBACKAP = (new MobEffectList(24, true, 5149489)).b("potion.antibackap").b(6, 0);
    public static final MobEffectList NOFALL = (new MobEffectList(25, false, 5149489)).b("potion.nofall").b(6, 1);
