...
public class Blocks {
   ...
   public static final Block AIR = (Block) Block.REGISTRY.get("air");
    ...
    public static final Block ANGELITE_ORE = (Block)Block.REGISTRY.get("angelite_ore");
    public static final Block ANGELITE_BLOCK = (Block)Block.REGISTRY.get("angelite_ore");
    
    public static final Block CELESTINE_ORE = (Block)Block.REGISTRY.get("celestine_ore");
    public static final Block CELESTINE_BLOCK = (Block)Block.REGISTRY.get("celestine_block");
    
    public static final Block MALACHITE_ORE = (Block)Block.REGISTRY.get("malachite_ore");
    public static final Block MALACHITE_BLOCK = (Block)Block.REGISTRY.get("malachite_block");
    
    public static final Block CELENITE_ORE = (Block)Block.REGISTRY.get("celenite_ore");
    public static final Block CELENITE_BLOCK = (Block)Block.REGISTRY.get("celenite_block");
 
    public static final Block RANDOM_ORE = (Block)Block.REGISTRY.get("random_ore");
    
    public static final Block XP_ORE = (Block)Block.REGISTRY.get("xp_ore");
    
    public static final Block CHILLI_PEPPER = (Block)Block.REGISTRY.get("chille_pepper");
}
