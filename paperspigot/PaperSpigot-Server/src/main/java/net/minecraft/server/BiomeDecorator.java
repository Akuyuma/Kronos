...
public class BiomeDecorator {
    ...
    protected WorldGenerator angeliteGen;
    protected WorldGenerator celestineGen;
    protected WorldGenerator malachiteGen;
    protected WorldGenerator celeniteGen;
    protected WorldGenerator randomGen;
    ...
    public BiomeDecorator() {
        ...
        this.angeliteGen = new WorldGenMinable(Blocks.ANGELITE_ORE, 1); 
        this.celestineGen = new WorldGenMinable(Blocks.CELESTINE_ORE, 3); 
        this.randomGen = new WorldGenMinable(Blocks.RANDOM_ORE, 3);         
        this.malachiteGen = new WorldGenMinable(Blocks.MALACHITE_ORE, 4); 
        this.celeniteGen = new WorldGenMinable(Blocks.CELENITE_ORE, 6);         
        this.xpGen = new WorldGenMinable(Blocks.XP_ORE, 4);         
    ...
    protected void a() {
        ...
        this.a(1, this.angeliteGen, 0, 12);
        this.a(2, this.celestineGen, 0, 16);
        this.a(2, this.randomGen, 0, 20);
        this.a(3, this.malachiteGen, 0, 20);
        this.a(4, this.xpGen, 0, 32);        
        this.a(5, this.celeniteGen, 0, 32);        
