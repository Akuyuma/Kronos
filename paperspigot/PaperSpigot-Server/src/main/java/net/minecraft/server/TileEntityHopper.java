...
import fr.maxlego08.kronos.craftbukkit.inventory.CraftInventoryAngeliteChest;
import fr.maxlego08.kronos.craftbukkit.inventory.CraftInventoryCeleniteChest;
import fr.maxlego08.kronos.craftbukkit.inventory.CraftInventoryCelestineChest;
import fr.maxlego08.kronos.craftbukkit.inventory.CraftInventoryMalachiteChest;
            ...
            if (this.a(iinventory, i)) {
                ...
                for (int j = 0; j < this.getSize(); ++j) {
                    if (this.getItem(j) != null) {
                        ...
                        }else if (iinventory instanceof TileEntityMalachiteChest){
                        	destinationInventory = new CraftInventoryMalachiteChest(iinventory);
                        }else if (iinventory instanceof TileEntityAngeliteChest){
                        	destinationInventory = new CraftInventoryAngeliteChest(iinventory);
                        }else if (iinventory instanceof TileEntityCelestineChest){
                        	destinationInventory = new CraftInventoryCelestineChest(iinventory);
                        }else if (iinventory instanceof TileEntityCeleniteChest){
                        	destinationInventory = new CraftInventoryCeleniteChest(iinventory);                        	
                        } else {
    ...
    private static boolean tryTakeInItemFromSlot(IHopper ihopper, IInventory iinventory, int i, int j) {
        ...
        if (itemstack != null && canTakeItemFromInventory(iinventory, itemstack, i, j)) {
            ...
            if (iinventory instanceof InventoryLargeChest) {
            	...
            	sourceInventory = new CraftInventoryMalachiteChest(iinventory);
            }else if (iinventory instanceof TileEntityAngeliteChest){
            	sourceInventory = new CraftInventoryAngeliteChest(iinventory);
            }else if (iinventory instanceof TileEntityCelestineChest){
            	sourceInventory = new CraftInventoryCelestineChest(iinventory);
            }else if (iinventory instanceof TileEntityCeleniteChest){
            	sourceInventory = new CraftInventoryCeleniteChest(iinventory);                 
            } else {
