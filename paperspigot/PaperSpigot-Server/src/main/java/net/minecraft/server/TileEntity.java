...
public class TileEntity {
    ...
    static {
         ...
         * Maxlego08
         * */
        a(TileEntityAngeliteChest.class, "AngeliteChest");
        a(TileEntityCelestineChest.class, "CelestineChest");
        a(TileEntityMalachiteChest.class, "MalachiteChest");
        a(TileEntityCeleniteChest.class, "CeleniteChest");
