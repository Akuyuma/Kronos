    ...
    public void h() {
        ...
        if (movingobjectposition != null) {
            if (movingobjectposition.type == EnumMovingObjectType.BLOCK && this.world.getType(movingobjectposition.b, movingobjectposition.c, movingobjectposition.d) == Blocks.PORTAL) {
                ...
                if ((this instanceof EntityGodPearl))
                {
                  if ((movingobjectposition.type == EnumMovingObjectType.BLOCK) 
                && (this.world.getType(movingobjectposition.b, movingobjectposition.c, movingobjectposition.d) != Blocks.IRON_FENCE) && 
                    (this.world.getType(movingobjectposition.b, movingobjectposition.c, movingobjectposition.d) != Blocks.THIN_GLASS) && 
                    (this.world.getType(movingobjectposition.b, movingobjectposition.c, movingobjectposition.d) != Blocks.STAINED_GLASS_PANE) && 
                    (this.world.getType(movingobjectposition.b, movingobjectposition.c, movingobjectposition.d) != Blocks.FENCE) && 
                    (this.world.getType(movingobjectposition.b, movingobjectposition.c, movingobjectposition.d) != Blocks.FENCE_GATE) && 
                    (this.world.getType(movingobjectposition.b, movingobjectposition.c, movingobjectposition.d) != Blocks.NETHER_FENCE) && 
                    (this.world.getType(movingobjectposition.b, movingobjectposition.c, movingobjectposition.d) != Blocks.SIGN_POST) && 
                    (this.world.getType(movingobjectposition.b, movingobjectposition.c, movingobjectposition.d) != Blocks.WALL_SIGN) && 
                    (this.world.getType(movingobjectposition.b, movingobjectposition.c, movingobjectposition.d) != Blocks.TRIPWIRE) && 
                    (this.world.getType(movingobjectposition.b, movingobjectposition.c, movingobjectposition.d) != Blocks.TRIPWIRE_SOURCE)) {
