...
public class Items {
    ...
    public static final Item ANGELITE = (Item)Item.REGISTRY.get("angelite");
    public static final Item ANGELITE_INGOT = (Item)Item.REGISTRY.get("angelite_ingot");
    public static final Item CELESTINE = (Item)Item.REGISTRY.get("celestine");
    public static final Item MALACHITE = (Item)Item.REGISTRY.get("malachite");
    public static final Item CELENITE = (Item)Item.REGISTRY.get("celenite");
    
    public static final Item ANGELITE_SWORD = (Item)Item.REGISTRY.get("angelite_sword");
    public static final Item ANGELITE_SHOVEL = (Item)Item.REGISTRY.get("angelite_shovel");
    public static final Item ANGELITE_PICKAXE = (Item)Item.REGISTRY.get("angelite_pickaxe");
    public static final Item ANGELITE_AXE = (Item)Item.REGISTRY.get("angelite_axe");
    public static final Item ANGELITE_HOE = (Item)Item.REGISTRY.get("angelite_hoe");
    public static final Item ANGELITE_MULTITOOLS = (Item)Item.REGISTRY.get("angelite_multitools");
    
    public static final Item CELESTINE_SWORD = (Item)Item.REGISTRY.get("celestine_sword");
    public static final Item CELESTINE_SHOVEL = (Item)Item.REGISTRY.get("celestine_shovel");
    public static final Item CELESTINE_PICKAXE = (Item)Item.REGISTRY.get("celestine_pickaxe");
    public static final Item CELESTINE_AXE = (Item)Item.REGISTRY.get("celestine_axe");
    public static final Item CELESTINE_HOE = (Item)Item.REGISTRY.get("celestine_hoe");
    public static final Item CELESTINE_MULTITOOLS = (Item)Item.REGISTRY.get("celestine_multitools");
    
    public static final Item MALACHITE_SWORD = (Item)Item.REGISTRY.get("malachite_sword");
    public static final Item MALACHITE_SHOVEL = (Item)Item.REGISTRY.get("malachite_shovel");
    public static final Item MALACHITE_PICKAXE = (Item)Item.REGISTRY.get("malachite_pickaxe");
    public static final Item MALACHITE_AXE = (Item)Item.REGISTRY.get("malachite_axe");
    public static final Item MALACHITE_HOE = (Item)Item.REGISTRY.get("malachite_hoe");
    public static final Item MALACHITE_MULTITOOLS = (Item)Item.REGISTRY.get("malachite_multitools");
    
    public static final Item CELENITE_SWORD = (Item)Item.REGISTRY.get("celenite_sword");
    public static final Item CELENITE_SHOVEL = (Item)Item.REGISTRY.get("celenite_shovel");
    public static final Item CELENITE_PICKAXE = (Item)Item.REGISTRY.get("celenite_pickaxe");
    public static final Item CELENITE_AXE = (Item)Item.REGISTRY.get("celenite_axe");
    public static final Item CELENITE_HOE = (Item)Item.REGISTRY.get("celenite_hoe");
    public static final Item CELENITE_MULTITOOLS = (Item)Item.REGISTRY.get("celenite_multitools");
    
    public static final Item ANGELITE_HELMET = (Item)Item.REGISTRY.get("angelite_helmet");
    public static final Item ANGELITE_CHESTPLATE = (Item)Item.REGISTRY.get("angelite_chestplate");
    public static final Item ANGELITE_LEGGINGS = (Item)Item.REGISTRY.get("angelite_leggings");
    public static final Item ANGELITE_BOOTS = (Item)Item.REGISTRY.get("angelite_boots");
    
    public static final Item CELESTINE_HELMET = (Item)Item.REGISTRY.get("celestine_helmet");
    public static final Item CELESTINE_CHESTPLATE = (Item)Item.REGISTRY.get("celestine_chestplate");
    public static final Item CELESTINE_LEGGINGS = (Item)Item.REGISTRY.get("celestine_leggings");
    public static final Item CELESTINE_BOOTS = (Item)Item.REGISTRY.get("celestine_boots");
    
    public static final Item MALACHITE_HELMET = (Item)Item.REGISTRY.get("malachite_helmet");
    public static final Item MALACHITE_CHESTPLATE = (Item)Item.REGISTRY.get("malachite_chestplate");
    public static final Item MALACHITE_LEGGINGS = (Item)Item.REGISTRY.get("malachite_leggings");
    public static final Item MALACHITE_BOOTS = (Item)Item.REGISTRY.get("malachite_boots");
    
    public static final Item CELENITE_HELMET = (Item)Item.REGISTRY.get("celenite_helmet");
    public static final Item CELENITE_CHESTPLATE = (Item)Item.REGISTRY.get("celenite_chestplate");
    public static final Item CELENITE_LEGGINGS = (Item)Item.REGISTRY.get("celenite_leggings");
    public static final Item CELENITE_BOOTS = (Item)Item.REGISTRY.get("celenite_boots");
    
    public static final Item MALEFICIENT_SCYTHE = (Item)Item.REGISTRY.get("maleficent_scythe");
    
    public static final Item BLADES_OF_ARES = (Item)Item.REGISTRY.get("blades_of_ares");
    
    public static final Item POSITIVE_GRAPES = (Item)Item.REGISTRY.get("positive_grapes");
    public static final Item GOLDEN_GRAPES = (Item)Item.REGISTRY.get("golden_grapes");
    public static final Item HEPHAISTOS_GRAPES = (Item)Item.REGISTRY.get("hephaistos_grapes");
    
    public static final Item FARMTOOLS = (Item)Item.REGISTRY.get("farmtools");

    public static final Item CREEPER_DIVIN = (Item)Item.REGISTRY.get("creeper_divin");
    
    public static final Item HEART_OF_CASSANDRE = (Item)Item.REGISTRY.get("heart_of_cassandre");
    
    public static final Item DYNAMITE = (Item)Item.REGISTRY.get("dynamite");
    
    public static final Item TARTARE_KEY = (Item)Item.REGISTRY.get("tartare_key");
    public static final Item SKY_KEY = (Item)Item.REGISTRY.get("sky_key");
    
    public static final Item STICK_OF_GODS = (Item)Item.REGISTRY.get("stick_of_gods");
    
  
    public static final Item STICK_OF_TARTARE = (Item)Item.REGISTRY.get("stick_of_tartare");
    
    public static final Item WATER_CAPSULE = (Item)Item.REGISTRY.get("water_capsule");
    public static final Item WATER_CAPSULE_EMPTY = (Item)Item.REGISTRY.get("water_capsule_empty");
    
    public static final Item GALAAD_SWORD = (Item)Item.REGISTRY.get("galaad_sword");
    
    public static final Item SOUL_OF_ANGELIC_SPAWNER = (Item)Item.REGISTRY.get("soul_of_angelic_spawner");
    
    public static final Item SOUL_OF_DEMONIC_SPAWNER = (Item)Item.REGISTRY.get("soul_of_demonic_spawner");
    
    public static final Item POWER_OF_HADES = (Item)Item.REGISTRY.get("power_of_hades");
    
    public static final Item HAMMER_OF_HESTIA = (Item)Item.REGISTRY.get("hammer_of_hestia");
    
    public static final Item CHILLI_PEPPER_ITEM = (Item)Item.REGISTRY.get("chilli_pepper_item");
    
    public static final Item POWER_OF_HERMES = (Item)Item.REGISTRY.get("power_of_hermes");
    
    public static final Item SPEED_GRAPES = (Item)Item.REGISTRY.get("speed_grapes");
    public static final Item FIRE_GRAPES = (Item)Item.REGISTRY.get("fire_grapes");
    public static final Item STRENGHT_GRAPES = (Item)Item.REGISTRY.get("strenght_grapes");
    public static final Item BUNCH_OF_GRAPES = (Item)Item.REGISTRY.get("bunch_of_grapes");
     
    public static final ItemBow celenite_bow = (ItemBow)Item.REGISTRY.get("celenite_bow");
    public static final ItemBow malachite_bow = (ItemBow)Item.REGISTRY.get("malachite_bow");
    public static final ItemBow celestine_bow = (ItemBow)Item.REGISTRY.get("celestine_bow");
    public static final ItemBow ANGELITE_BOW = (ItemBow)Item.REGISTRY.get("angelite_bow");
    public static final ItemBow APOLON_BOW = (ItemBow)Item.REGISTRY.get("apolon_bow");
    
    public static final Item ANGELITE_ARROW = (Item)Item.REGISTRY.get("angelite_arrow");
    
    public static final Item KUNEES_OF_HADES = (Item)Item.REGISTRY.get("kunees_of_hades");
