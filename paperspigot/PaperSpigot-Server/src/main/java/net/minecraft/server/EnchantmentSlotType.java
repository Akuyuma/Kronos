...
public enum EnchantmentSlotType {
    ...
    public boolean canEnchant(Item item) {
        if (this == ALL) {
            ...
            return item instanceof ItemSword ? this == WEAPON : (item instanceof ItemTool ? this == DIGGER : (item instanceof ItemApolonBow ? this == BOW : (item instanceof ItemFishingRod ? this == FISHING_ROD : false)));
        }
    }
}