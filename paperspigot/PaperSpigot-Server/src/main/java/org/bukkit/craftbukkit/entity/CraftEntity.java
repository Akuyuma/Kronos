...
public abstract class CraftEntity implements org.bukkit.entity.Entity {
    ...
    public static CraftEntity getEntity(CraftServer server, Entity entity) {
        ...
        if (entity instanceof EntityLiving) {
            ...
            return new CraftDynamite(server, (EntityDynamite)entity);
         }        
        else if ((entity instanceof EntityGodPearl)) {
        	return new CraftGodPearl(server, (EntityGodPearl)entity);
        }        
            ...
            else if (entity instanceof EntityGodPearl) { return new CraftGodPearl(server, (EntityGodPearl) entity); }
