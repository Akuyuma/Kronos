...
public class Potion
{
    ...
    public static final Potion antibackAp = (new Potion(24, true, 3484199)).setPotionName("potion.antibackap").setIconIndex(6, 0);
    
    public static final Potion nofall = (new Potion(25, false, 3484199)).setPotionName("potion.nofall").setIconIndex(6, 1);
