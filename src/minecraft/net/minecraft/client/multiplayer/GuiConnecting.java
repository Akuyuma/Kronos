...
public class GuiConnecting extends GuiScreen
{
        ...
        (new Thread("Server Connector #" + field_146372_a.incrementAndGet())
        {
            ...
            public void run()
            {
                ...
                catch (UnknownHostException var5)
                {
                    ...
                    GuiConnecting.this.mc.displayGuiScreen(new GuiDisconnected(GuiConnecting.this.field_146374_i, "connect.failed", new ChatComponentTranslation("disconnect.genericReason", new Object[] {"§eServeur inconue !"})));
                }
                catch (Exception var6)
                {
                    ...
                    GuiConnecting.this.mc.displayGuiScreen(new GuiDisconnected(GuiConnecting.this.field_146374_i, "connect.failed", new ChatComponentTranslation("disconnect.genericReason", new Object[] {"§eLe serveur est indisponible pour le moment !"})));
                }
            }
        }).start();
    }
        ...
        if (this.field_146371_g != null)
        {
            if (this.field_146371_g.isChannelOpen())
            {
            	try{
					...
					System.err.println("Le serveur est en premium !");
				}
            }
    ...
    public void initGui()
    {
        ...
        this.buttonList.add(new GuiButtonMain(0, this.width / 2 - 100, this.height / 2 + 50, 200, 25, I18n.format("gui.cancel", new Object[0])));
    }
    ...
    public void drawScreen(int x, int y, float p_73863_3_)
    {
        ...
        if (this.field_146371_g == null)
        {
            this.drawCenteredString(this.fontRendererObj, "Connexion au serveur !", this.width / 2, this.height / 2 - 50, 16777215);
        }
        else
        {
            this.drawCenteredString(this.fontRendererObj, "Connexion au serveur !", this.width / 2, this.height / 2 - 50, 16777215);
