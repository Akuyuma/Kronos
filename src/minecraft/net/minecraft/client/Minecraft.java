...
import fr.maxlego08.kronos.gui.modified.GuiIngame;
import fr.maxlego08.kronos.gui.modified.GuiIngameMenu;
import fr.maxlego08.kronos.gui.modified.GuiMainMenu;
import fr.maxlego08.kronos.init.Bootstrap;
...
public class Minecraft implements IPlayerUsage
{
    ...
    public Minecraft(Session p_i1103_1_, int p_i1103_2_, int p_i1103_3_, boolean p_i1103_4_, boolean p_i1103_5_, File p_i1103_6_, File p_i1103_7_, File p_i1103_8_, Proxy p_i1103_9_, String p_i1103_10_, Multimap p_i1103_11_, String p_i1103_12_)
    {
        ...
        logger.info("Lancement de Kronos");
        kronos = new Kronos();
        kronos.init();
        
        Bootstrap.func_151354_b();
        logger.info("Lancement de Kronos effectué avec succès ! (Chargement effectuté en " + Math.abs(ms-System.currentTimeMillis())+"ms)");
    }
    ...
    private void startGame() throws LWJGLException
    {
        ...
        Display.setTitle("Kronos " + this.session.getUsername());
