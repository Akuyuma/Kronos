...
public class GuiDisconnected extends GuiScreen
{
    ...
    public void initGui()
    {
        ...
        this.buttonList.add(new GuiButtonMain(0, this.width / 2 - 100, this.height / 4 + 120 + 12, 200, 25, I18n.format("gui.toMenu", new Object[0]), 2));
    ...
    {
        this.drawDefaultBackground(p_73863_1_, p_73863_2_);
