...
public abstract class GuiSlot
{
    ...
    public void func_148128_a(int p_148128_1_, int p_148128_2_, float p_148128_3_)
    {
        ...
        this.mc.getTextureManager().bindTexture(new ResourceLocation("textures/gui/kronos/wallpaper.png"));
        GL11.glColor4f(1.0F, 1.0F, 1.0F, 1.0F);
        float var17 = Minecraft.getMinecraft().displayWidth;
    	...
    	drawTextureWithOptionalSize(0, 30, 0, 0, width, height, width, height);
        ...
        /*
         * Cette fonction draw les message
         * */
	...
	private int getDistanceTo(int z, boolean e){
		...
		if (e){			
			return Math.abs(width / 2 - z);
		}
		return Math.abs(height / 2 - z);
	}
