...
import fr.maxlego08.kronos.renderer.TileEntityAngeliteChestRenderer;
import fr.maxlego08.kronos.renderer.TileEntityCeleniteChestRenderer;
import fr.maxlego08.kronos.renderer.TileEntityCelestineChestRenderer;
import fr.maxlego08.kronos.renderer.TileEntityMalachiteChestRenderer;
...
public class TileEntityRendererDispatcher
{
    ...
    private TileEntityRendererDispatcher()
    {
        ...
        this.mapSpecialRenderers.put(TileEntityAngeliteChest.class, new TileEntityAngeliteChestRenderer());
        this.mapSpecialRenderers.put(TileEntityCelestineChest.class, new TileEntityCelestineChestRenderer());
        this.mapSpecialRenderers.put(TileEntityMalachiteChest.class, new TileEntityMalachiteChestRenderer());
        this.mapSpecialRenderers.put(TileEntityCeleniteChest.class, new TileEntityCeleniteChestRenderer());
