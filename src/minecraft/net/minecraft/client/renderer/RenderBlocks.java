...
import fr.maxlego08.kronos.blocks.BlockChilliPepper;
...
public class RenderBlocks
{
        ...
        else
        {
            try
            {
                ...
                switch (i)
                {
                    ...
                    case 28:{
                    	if (par1Block instanceof BlockCocoa){
                    		var6 = this.renderBlockCocoa((BlockCocoa)par1Block, par2, par3, par4);
                    	}else{
                    		var6 = this.renderBlockChilletPepper((BlockChilliPepper)par1Block, par2, par3, par4);                   		
                    	}
                        return var6;
                    }
                    case 29:
    ...
    public boolean renderBlockChilletPepper(BlockChilliPepper p_147772_1_, int p_147772_2_, int p_147772_3_, int p_147772_4_)
    {
    	Tessellator var5 = Tessellator.instance;
    	var5.setBrightness(p_147772_1_.getBlockBrightness(this.blockAccess, p_147772_2_, p_147772_3_, p_147772_4_));
    	var5.setColorOpaque_F(1.0F, 1.0F, 1.0F);
    	int var6 = this.blockAccess.getBlockMetadata(p_147772_2_, p_147772_3_, p_147772_4_);
    	int var7 = BlockDirectional.func_149895_l(var6);
    	int var8 = BlockChilliPepper.func_149987_c(var6);
    	IIcon var9 = p_147772_1_.func_149988_b(var8);
    	int var10 = 4 + var8 * 2;
    	int var11 = 5 + var8 * 2;
    	double var12 = 15.0D - (double)var10;
