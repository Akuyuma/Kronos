            ...
            for (var26 = 0; var26 < this.tileEntities.size(); ++var26)
            {
                ...
                if (!hasTileEntityShouldRenderInPass || Reflector.callBoolean(var29, Reflector.ForgeTileEntity_shouldRenderInPass, new Object[] {Integer.valueOf(pass)}))
                {
                    ...
                    if (var30 == AABB_INFINITE || p_147589_2_.isBoundingBoxInFrustum(var30))
                    {
                        ...
                        if (var31 == TileEntityAngeliteChest.class)
                        {
                        	Block var32 = this.theWorld.getBlock(var29.field_145851_c, var29.field_145848_d, var29.field_145849_e);
                        	
                        	if (!(var32 instanceof BlockAngeliteChest))
                        	{
                        		continue;
                        	}
                        }
                        if (var31 == TileEntityCelestineChest.class)
                        {
                        	Block var32 = this.theWorld.getBlock(var29.field_145851_c, var29.field_145848_d, var29.field_145849_e);
                        	
                        	if (!(var32 instanceof BlockCelestineChest))
                        	{
                        		continue;
                        	}
                        }
                        if (var31 == TileEntityMalachiteChest.class)
                        {
                        	Block var32 = this.theWorld.getBlock(var29.field_145851_c, var29.field_145848_d, var29.field_145849_e);
                        	
                        	if (!(var32 instanceof BlockMalachiteChest))
                        	{
                        		continue;
                        	}
                        }
                        if (var31 == TileEntityCeleniteChest.class)
                        {
                        	Block var32 = this.theWorld.getBlock(var29.field_145851_c, var29.field_145848_d, var29.field_145849_e);
                        	
                        	if (!(var32 instanceof BlockCeleniteChest))
                        	{
                        		continue;
                        	}
                        }
