...
import fr.maxlego08.kronos.renderer.RenderDynamite;
...
public class RenderManager
{
    ...
    private RenderManager()
    {
        ...
        this.entityRenderMap.put(EntityDynamite.class, new RenderDynamite());
        this.entityRenderMap.put(EntityGodPearl.class, new RenderSnowball(Items.GOD_PEARL));
