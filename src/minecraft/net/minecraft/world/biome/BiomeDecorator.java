...
public class BiomeDecorator
{
    ...
    protected void generateOres()
    {
        ...
        this.genStandardOre1(1, this.angeliteGen, 0, 12);
        this.genStandardOre1(2, this.celestineGen, 0, 16);
        this.genStandardOre1(3, this.malachiteGen, 0, 20);
        this.genStandardOre1(5, this.celeniteGen, 0, 32);
