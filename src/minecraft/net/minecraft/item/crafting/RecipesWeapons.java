...
public class RecipesWeapons
{
    ...
    {
        this.recipeItems = new Object[][] {{Blocks.planks, Blocks.cobblestone, Items.iron_ingot, Items.diamond, Items.gold_ingot, Items.ANGELITE, Items.CELESTINE, Items.MALACHITE, Items.CELENITE}, 
        	{Items.wooden_sword, Items.stone_sword, Items.iron_sword, Items.diamond_sword, Items.golden_sword
        	, Items.ANGELITE_SWORD, Items.CELESTINE_SWORD, Items.MALACHITE_SWORD, Items.CELENITE_SWORD}};
    }
