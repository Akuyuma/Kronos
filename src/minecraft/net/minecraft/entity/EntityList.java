...
import fr.maxlego08.kronos.entities.Entities;
...
public class EntityList
{
    ...
    static
    {
        ...
        for(Entities entity : Entities.values()){
        	if (entity.hasColoredEgg()){     		
        		addMapping(entity.getEntity(), entity.getName(), entity.getId(), entity.getEggColorBack(), entity.getEggColorFront());
        	}else{
        		addMapping(entity.getEntity(), entity.getName(), entity.getId());
        	}
        }
    }
