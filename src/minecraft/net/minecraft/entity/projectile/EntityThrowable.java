        ...
        if (var3 != null)
        {
            ...
            if(this instanceof EntityGodPearl)
            {
                if(var3.typeOfHit == MovingObjectPosition.MovingObjectType.BLOCK 
                		&& worldObj.getBlock(var3.blockX, var3.blockY, var3.blockZ) != Blocks.iron_bars 
                		&& worldObj.getBlock(var3.blockX, var3.blockY, var3.blockZ) != Blocks.glass_pane 
                		&& worldObj.getBlock(var3.blockX, var3.blockY, var3.blockZ) != Blocks.stained_glass_pane 
                		&& worldObj.getBlock(var3.blockX, var3.blockY, var3.blockZ) != Blocks.fence 
                		&& worldObj.getBlock(var3.blockX, var3.blockY, var3.blockZ) != Blocks.fence_gate 
                		&& worldObj.getBlock(var3.blockX, var3.blockY, var3.blockZ) != Blocks.nether_brick_fence 
                		&& worldObj.getBlock(var3.blockX, var3.blockY, var3.blockZ) != Blocks.standing_sign 
                		&& worldObj.getBlock(var3.blockX, var3.blockY, var3.blockZ) != Blocks.tripwire_hook 
                		&& worldObj.getBlock(var3.blockX, var3.blockY, var3.blockZ) != Blocks.tripwire 
                		&& worldObj.getBlock(var3.blockX, var3.blockY, var3.blockZ) != Blocks.wall_sign)
                    onImpact(var3);
            } else
