...
public abstract class EntityPlayer extends EntityLivingBase implements ICommandSender
{
    ...
    public IIcon getItemIcon(ItemStack p_70620_1_, int p_70620_2_)
    {
        ...
        else
        {
            ...
            if (this.itemInUse != null && p_70620_1_.getItem() == Items.APOLON_BOW)
            {
            	int var4 = p_70620_1_.getMaxItemUseDuration() - this.itemInUseCount;
            	
            	if (var4 >= 18)
            	{
            		return Items.APOLON_BOW.getItemIconForUseDuration(2);
            	}
            	
            	if (var4 > 13)
            	{
            		return Items.APOLON_BOW.getItemIconForUseDuration(1);
            	}
            	
            	if (var4 > 0)
            	{
            		return Items.APOLON_BOW.getItemIconForUseDuration(0);
            	}
            }
            if (this.itemInUse != null && p_70620_1_.getItem() == Items.celenite_bow)
            {
            	int var4 = p_70620_1_.getMaxItemUseDuration() - this.itemInUseCount;
            	
            	if (var4 >= 18)
            	{
            		return Items.celenite_bow.getItemIconForUseDuration(2);
            	}
            	
            	if (var4 > 13)
            	{
            		return Items.celenite_bow.getItemIconForUseDuration(1);
            	}
            	
            	if (var4 > 0)
            	{
            		return Items.celenite_bow.getItemIconForUseDuration(0);
            	}
            }
            if (this.itemInUse != null && p_70620_1_.getItem() == Items.malachite_bow)
            {
            	int var4 = p_70620_1_.getMaxItemUseDuration() - this.itemInUseCount;
            	
            	if (var4 >= 18)
            	{
            		return Items.malachite_bow.getItemIconForUseDuration(2);
            	}
            	
            	if (var4 > 13)
            	{
            		return Items.malachite_bow.getItemIconForUseDuration(1);
            	}
            	
            	if (var4 > 0)
            	{
            		return Items.malachite_bow.getItemIconForUseDuration(0);
            	}
            }
            if (this.itemInUse != null && p_70620_1_.getItem() == Items.celestine_bow)
            {
            	int var4 = p_70620_1_.getMaxItemUseDuration() - this.itemInUseCount;
            	
            	if (var4 >= 18)
            	{
            		return Items.celestine_bow.getItemIconForUseDuration(2);
            	}
            	
            	if (var4 > 13)
            	{
            		return Items.celestine_bow.getItemIconForUseDuration(1);
            	}
            	
            	if (var4 > 0)
            	{
            		return Items.celestine_bow.getItemIconForUseDuration(0);
            	}
            }
            if (this.itemInUse != null && p_70620_1_.getItem() == Items.ANGELITE_BOW)
            {
            	int var4 = p_70620_1_.getMaxItemUseDuration() - this.itemInUseCount;
            	
            	if (var4 >= 18)
            	{
            		return Items.ANGELITE_BOW.getItemIconForUseDuration(2);
            	}
            	
            	if (var4 > 13)
            	{
            		return Items.ANGELITE_BOW.getItemIconForUseDuration(1);
            	}
            	
            	if (var4 > 0)
            	{
            		return Items.ANGELITE_BOW.getItemIconForUseDuration(0);
            	}
            }
        }
