...
public abstract class CreativeTabs
{
    ...
    public static final List<CreativeTabs> creativeTabArray = new ArrayList<CreativeTabs>();
	...
	public static final CreativeTabs tabsOutils = new CreativeTabs("kronos_outils") {
		
		@Override
		public Item getTabIconItem() {
			return fr.maxlego08.kronos.items.Items.ANGELITE.getItem();
		}
	};
	
	public static final CreativeTabs tabsCombat = new CreativeTabs("kronos_combat") {
	...
	public static final CreativeTabs tabsBlocks = new CreativeTabs("kronos_blocks") {
	...
	public static final CreativeTabs tabsDivers = new CreativeTabs("kronos_divers") {
		
		@Override
		public Item getTabIconItem() {
			return Item.getItemById(399);
		}
	};
	
	public static final CreativeTabs tabsBouffe = new CreativeTabs("kronos_bouffe") {
    ...
    public CreativeTabs(int index, String label)
    {
        this.tabIndex = index;
        this.tabLabel = label;
        creativeTabArray.add(this);
    }
    
    //Slixe
    public CreativeTabs(String label)
    {
        this(creativeTabArray.size(), label);
    }
