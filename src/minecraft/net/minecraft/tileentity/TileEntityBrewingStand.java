            ...
            else
            {
                ...
                for (int var3 = 0; var3 < 3; ++var3)
                {
                    if (this.field_145945_j[var3] != null && this.field_145945_j[var3].getItem() == Items.potionitem)
                    {
                        ...
                        /*
                         * On désactive les potions qu'on ne veut pas qu'elles soit activé 
                         * */
                        
                        if (var5 == 8268 || var5 == 8236 || var5 == 16460 || var5 == 16428 || var5 == 16420){
                        	return false;
                        }
    ...
    private void func_145940_l()
    {
        if (this.func_145934_k())
        {
            ...
            for (int var2 = 0; var2 < 3; ++var2)
            {
                ...
                {
                    int idAvant = this.field_145945_j[var2].getItemDamage();
                    int newId = this.func_145936_c(idAvant, var1);
                    List var5 = Items.potionitem.getEffects(idAvant);
                    List var6 = Items.potionitem.getEffects(newId);
                    
                    if ((idAvant <= 0 || var5 != var6) && (var5 == null || !var5.equals(var6) && var6 != null))
                    {
                        if (idAvant != newId)
                        {
                            this.field_145945_j[var2].setItemDamage(newId);
                        }
                    }
                    else if (!ItemPotion.isSplash(idAvant) && ItemPotion.isSplash(newId))
                    {
                        this.field_145945_j[var2].setItemDamage(newId);
                    }
                }
