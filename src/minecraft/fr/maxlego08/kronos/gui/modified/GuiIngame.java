...
public class GuiIngame extends Gui
{
    ...
    public void renderGameOverlay(float p_73830_1_, boolean p_73830_2_, int p_73830_3_, int p_73830_4_)
    {
        ...
        if (this.mc.gameSettings.showDebugInfo)
        {
            ...
            this.mc.mcProfiler.startSection("debug");
            if (Minecraft.debugFPS > 200){
            	this.mc.debug = ("§2"+ Minecraft.debugFPS+" §eFPS");
            }else if (Minecraft.debugFPS >= 100 && Minecraft.debugFPS <= 200){
            	this.mc.debug = ("§a"+ Minecraft.debugFPS+" §eFPS");
            }else if (Minecraft.debugFPS < 100 && Minecraft.debugFPS >= 50){
            	this.mc.debug = ("§e"+ Minecraft.debugFPS+" §eFPS");
            }else if (Minecraft.debugFPS < 50 && Minecraft.debugFPS >= 25){
            	this.mc.debug = ("§c"+ Minecraft.debugFPS+" §eFPS");
            }else if (Minecraft.debugFPS < 25){
            	this.mc.debug = ("§4"+ Minecraft.debugFPS+" §eFPS");
            }
            
            var8.drawStringWithShadow("§6» §eKronos §6V§e"+Kronos.getKronos().getClientVersion()+" §8(§7" + this.mc.debug + "§8)", 2, 2, 16777215);
            
            var8.drawStringWithShadow(String.format("§6» §ex§7: §a%.2f", new Object[] {Double.valueOf(this.mc.thePlayer.posX)}), 2, 12, 14737632);
    		var8.drawStringWithShadow(String.format("§6» §ey§7: §a%.2f", new Object[] {Double.valueOf(this.mc.thePlayer.boundingBox.minY)}), 2, 22, 14737632);
    		var8.drawStringWithShadow(String.format("§6» §ez§7: §a%.2f", new Object[] {Double.valueOf(this.mc.thePlayer.posZ)}), 2, 32, 14737632);
            int var25 = MathHelper.floor_double((double)(this.mc.thePlayer.rotationYaw * 4.0F / 360.0F) + 0.5D) & 3;
            this.drawString(var8, "§6» §eDirection§7: §a"+Direction.directions[var25].replace("SOUTH", "Sud").replace("NORTH", "Nord").replace("EAST", "Est").replace("WEST", "Ouest"), 2, 42, 14737632);
            ...
            this.drawString(var8, "§6» §eBiome§7: §a"+var26.getBiomeGenForWorldCoords(var22 & 15, var24 & 15, this.mc.theWorld.getWorldChunkManager()).biomeName, 2, 52, 14737632);
            ...
            String var20 = "§eMémoire utilisée§7: §a" + var45 * 100L / var36 + "§e% §7(§a" + var45 / 1024L / 1024L + "§eMB§7) §eof §a" + var36 / 1024L / 1024L + "§eMB";
            var21 = 14737632;
            this.drawString(var8, var20, var6 - var8.getStringWidth(var20) - 2, 2, 14737632);
            var20 = "§eMémoire allouée§7: §a" + var41 * 100L / var36 + "§e% §7(§a" + var41 / 1024L / 1024L + "§eMB§7)";
