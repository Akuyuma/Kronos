...
public class ItemAngeliteBow extends ItemBow{

	public ItemAngeliteBow() {
		setMaxDamage(1134);
	}
    ...
    public void onPlayerStoppedUsing(ItemStack p_77615_1_, World p_77615_2_, EntityPlayer p_77615_3_, int p_77615_4_)
    {
        ...
        if (var5 || p_77615_3_.inventory.hasItem(Items.ANGELITE_ARROW))
        {
...
//            }
            ...
            {
                p_77615_3_.inventory.consumeInventoryItem(Items.ANGELITE_ARROW);
            }
    ...
    {
        if (p_77659_3_.capabilities.isCreativeMode || p_77659_3_.inventory.hasItem(Items.ANGELITE_ARROW))
        {
