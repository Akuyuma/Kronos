...
public class ItemBladesOfAres extends Item
{
    ...
    public ItemBladesOfAres(Item.ToolMaterial p_i45356_1_)
    {
    ...
    {
        return this.field_150933_b.getBaseItemForRepair() == p_82789_2_.getItem() ? true : super.getIsRepairable(p_82789_1_, p_82789_2_);
    }
    ...
    @Override
    public void onUpdate(ItemStack item, World world, Entity entity, int unChiffre,
    		boolean unBoolean) {
    	...
    	if (entity instanceof EntityPlayer){
    		...
    		if (player.getCurrentEquippedItem() != null && item.getItem() == player.getCurrentEquippedItem().getItem()){
    	...
    	super.onUpdate(item, world, entity, unChiffre, unBoolean);
    }
}
