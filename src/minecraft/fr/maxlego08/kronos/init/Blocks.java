package fr.maxlego08.kronos.init;

import fr.maxlego08.kronos.blocks.BlockAngeliteChest;
import fr.maxlego08.kronos.blocks.BlockCeleniteChest;
import fr.maxlego08.kronos.blocks.BlockCelestineChest;
import fr.maxlego08.kronos.blocks.BlockMalachiteChest;
...
public class Blocks
{
    ...
    public static final Block ANGELITE_ORE = (Block)Block.blockRegistry.getObject("angelite_ore");
    public static final Block ANGELITE_BLOCK = (Block)Block.blockRegistry.getObject("angelite_ore");
    
    public static final Block CELESTINE_ORE = (Block)Block.blockRegistry.getObject("celestine_ore");
    public static final Block CELESTINE_BLOCK = (Block)Block.blockRegistry.getObject("celestine_block");
    
    public static final Block MALACHITE_ORE = (Block)Block.blockRegistry.getObject("malachite_ore");
    public static final Block MALACHITE_BLOCK = (Block)Block.blockRegistry.getObject("malachite_block");
    
    public static final Block CELENITE_ORE = (Block)Block.blockRegistry.getObject("celenite_ore");
    public static final Block CELENITE_BLOCK = (Block)Block.blockRegistry.getObject("celenite_block");
    
    public static final Block RADNOM_ORE = (Block)Block.blockRegistry.getObject("random_ore");
    
    public static final Block XP_ORE = (Block)Block.blockRegistry.getObject("xp_ore");
    
    public static final BlockAngeliteChest ANGELITE_CHEST = (BlockAngeliteChest)Block.blockRegistry.getObject("angelite_chest");
    public static final BlockCelestineChest CELESTINE_CHEST = (BlockCelestineChest)Block.blockRegistry.getObject("celestine_chest");
    public static final BlockMalachiteChest MALACHITE_CHEST = (BlockMalachiteChest)Block.blockRegistry.getObject("malachite_chest");
    public static final BlockCeleniteChest CELENITE_CHEST = (BlockCeleniteChest)Block.blockRegistry.getObject("celenite_chest");
    
    public static final Block CHILLI_PEPPER = (Block)Block.blockRegistry.getObject("chille_pepper");
